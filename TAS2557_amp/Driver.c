...
#pragma alloc_text (PAGE, tas2557ampEvtDeviceAdd)
#pragma alloc_text (PAGE, tas2557ampEvtDriverContextCleanup)
#endif
...
--*/
{
    ...
    attributes.EvtCleanupCallback = tas2557ampEvtDriverContextCleanup;

    WDF_DRIVER_CONFIG_INIT(&config,
                           tas2557ampEvtDeviceAdd
                           );
...
--*/
{
    ...
    status = tas2557ampCreateDevice(DeviceInit);
...
VOID
tas2557ampEvtDriverContextCleanup(
